...
```bash
git clone https://github.com/<username>/next-seo
```
...
[license]: https://github.com/bradgarropy/next-seo/blob/master/license
[fork]: https://github.com/bradgarropy/next-seo/fork
[contributors]: https://github.com/bradgarropy/next-seo#-contributors
